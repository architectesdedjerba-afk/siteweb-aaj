  ...
  return (
    <>
      <SEO
        ...
        description="Mentions légales, conditions d'utilisation et politique de confidentialité du site de l'Association des Architectes de Jerba."
      ...
      <div className="pt-16 min-h-screen bg-white">
        ...
        <section className="max-w-3xl mx-auto px-6 py-16 space-y-12 text-aaj-dark">
          ...
          <article>
            ...
            <p className="text-sm leading-relaxed text-aaj-gray">
              Le site est hébergé sur l'infrastructure Google Cloud / Firebase Hosting (Google LLC,
          ...
          <article>
            ...
            <p className="text-sm leading-relaxed text-aaj-gray">
              ...
              (session Firebase). Aucun cookie publicitaire ou de suivi tiers n'est déposé. Votre
              consentement est recueilli lors de votre première visite.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="text-sm leading-relaxed text-aaj-gray">
              L'AAJ s'efforce de garantir l'exactitude des informations diffusées mais ne saurait
              être tenue responsable des erreurs, omissions ou indisponibilités techniques.
            </p>
          </article>
        </section>
      </div>
