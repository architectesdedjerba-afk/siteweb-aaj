    ...
    return (
      <>
        <SEO
          ...
          description="Espace privé des membres de l'AAJ : annuaire, actualités internes, documents, PVs."
                    ...
                    >
                      ...
                      {selectedCommune ? (
                        <div className="space-y-4">
                              ...
                              >
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                  ...
                                  <a
                                    ...
                                    download={
                                      pv.fileName ||
                                      `PV_Commission_${selectedCommune}_${pv.date}.pdf`
                                    }
                          ...
                          {commissionPVs.filter((pv) => pv.town === selectedCommune).length ===
                            0 && (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-200">
                              <div className="space-y-3">
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    setNewDoc({ ...newDoc, commune: e.target.value })
                                  }
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-end gap-8">
                        <div>
                          ...
                          <p className="text-sm text-aaj-gray font-bold uppercase tracking-widest max-w-2xl leading-relaxed">
                            Découvrez les partenaires qui soutiennent l'AAJ et bénéficiez d'offres
                            exclusives réservées aux adhérents.
                          </p>
                        </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-aaj-gray font-bold text-[10px] uppercase tracking-[3px]">
              {isResetMode ? 'Saisissez votre email' : "Accès réservé aux membres de l'AAJ"}
            </p>
            {!isResetMode && (
              <p className="text-aaj-gray text-xs mt-4 font-medium normal-case tracking-normal">
                Pas encore adhérent ?{' '}
                <Link to="/demander-adhesion" className="text-aaj-royal font-bold hover:underline">
