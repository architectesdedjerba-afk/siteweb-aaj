...
const FALLBACK: NewsItem[] = [
  {
    ...
    date: '2026-10-22',
    type: 'Future',
    content: 'Discussion sur la préservation des Menzel.',
  },
  {
    title: 'Atelier de Restauration du Patrimoine',
    date: '2026-11-15',
    type: 'Future',
    content: 'Discussion sur la préservation des Menzel.',
  },
  {
    title: 'Conférence Patrimoine',
    date: '2026-05-15',
    type: 'Future',
    content: 'Discussion sur la préservation des Menzel.',
  },
  {
    title: 'Exposition Archi Jerba',
    date: '2026-06-10',
    type: 'Future',
    content: "Vernissage des projets de fin d'études.",
  },
  {
    title: 'Atelier Urbanisme',
    date: '2026-03-20',
    type: 'Past',
    content: 'Rapport sur la gestion des côtes.',
  },
];
...
export const NewsPage = () => {
  ...
  return (
    <>
      <SEO
        title="Évènements & actualités"
        description="Colloques, ateliers, expositions et conférences de l'Association des Architectes de Jerba. Tous les évènements passés et à venir."
        path="/evennements"
      />
      <div className="pt-16 min-h-screen bg-white">
        <header className="border-b border-aaj-border py-16 text-center">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-4 uppercase tracking-tighter">
              Évènements
            </h1>
            <p className="text-aaj-gray text-sm md:text-base max-w-xl mx-auto font-medium uppercase tracking-widest leading-relaxed">
              ...
              <div className="lg:col-span-2 space-y-12">
                <div>
                  <h2 className="text-[12px] uppercase tracking-[2px] text-aaj-gray font-bold mb-8 flex items-center gap-4">
                    ...
                    <span className="flex-1 h-px bg-aaj-border" aria-hidden="true"></span>
                  </h2>
                    ...
                    {events
                      ...
                      .map((e, idx) => (
                        <article key={e.id ?? idx} className="flex gap-6 items-start group">
                          <div
                            className="min-w-[60px] h-[60px] bg-aaj-soft rounded flex flex-col items-center justify-center border border-aaj-royal/10"
                            aria-hidden="true"
                          >
                            <span className="block text-2xl font-black text-aaj-royal leading-none">
                          ...
                          <div>
                            <h3 className="text-lg font-bold mb-2 group-hover:text-aaj-royal transition-colors uppercase tracking-tight">
                              {e.title}
                            </h3>
                            <p className="text-aaj-gray text-sm font-medium mb-4 leading-relaxed">
                              {e.content}
                            </p>
                            <button
                              type="button"
                              className="text-aaj-royal text-xs font-bold uppercase tracking-widest flex items-center gap-2 hover:underline"
                            >
                  ...
                  <div className="space-y-4">
                    {events
                      ...
                      .map((e, idx) => (
                        <article
                          key={e.id ?? idx}
                          className="px-6 py-4 border border-aaj-border flex justify-between items-center bg-slate-50/50 rounded"
                        >
                          <div className="flex items-center gap-6 text-sm">
                            <time
                              className="text-aaj-gray font-bold font-mono text-xs"
                              dateTime={e.date}
                            >
                              {e.date}
                            </time>
                            <h4 className="font-bold text-aaj-dark uppercase text-xs tracking-wider">
                              {e.title}
                            </h4>
                          </div>
                          <span className="text-[9px] uppercase tracking-[2px] font-black text-aaj-gray bg-white border border-aaj-border px-3 py-1 rounded">
                            Terminé
                          </span>
                        </article>
                      ))}
