    ...
    return (
      <>
        <SEO
          ...
          description="Soutenez l'Association des Architectes de Jerba. Formulaire pour devenir partenaire Platine, Or ou Argent de l'AAJ."
        ...
        <div className="pt-24 min-h-screen flex items-center justify-center p-6 bg-white">
          ...
          >
            ...
            <p className="text-aaj-gray font-medium text-sm leading-relaxed mb-10">
              Merci de votre intérêt pour l'AAJ. Notre bureau des partenariats examinera votre
              demande et vous contactera dans les plus brefs délais.
            </p>
            <Link
              to="/"
